...
public:
  ...
  double run()
  {
    ...
    for (int i = 0; i < n_itter; i++)
    {
      ...
      {
        cout << optimal_length << " - " << "Time limit" << " - " << stringifyVectorInt(optimal_path, optimal_path.size()) << endl;        //cout << "[Time limit] Breaking at iteration: " << i << " with best path length: " << optimal_length << endl;
        return optimal_length;
      }

      if ((i - last_itter) > 50)
      {
        cout << optimal_length << " - " << "Improvement limit" << " - " << stringifyVectorInt(optimal_path, optimal_path.size()) << endl;
    ...
    cout << optimal_length << " - " << "Natural stop" << " - " << stringifyVectorInt(optimal_path, optimal_path.size()) << endl;        //cout << "[Time limit] Breaking at iteration: " << i << " with best path length: " << optimal_length << endl;
    return optimal_length;
  }
};
